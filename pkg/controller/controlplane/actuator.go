...
import (
	...
	networking "github.com/gardener/gardener-extension-provider-alicloud/pkg/utils/networking"
)
...
const (
	...
	AnnotationCalicoCleanupCompleted = "alicloud.provider.extensions.gardener.cloud/calico-cleanup-completed"
)
