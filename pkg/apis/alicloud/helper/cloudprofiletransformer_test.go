						...
						Versions: []v1alpha1.MachineImageVersion{
							{
								Version: "20.04",
								Regions: []v1alpha1.RegionIDMapping{
									{Name: "eu-west-1", ID: "id-123"}, // No architecture specified
								},
							},
						},
					},
								...
								CapabilityFlavors: []v1alpha1.MachineImageFlavor{
									{
										...
										Regions:      []v1alpha1.RegionIDMapping{{Name: "eu-west-1", ID: "id-123"}},
									},
								},
							},
						},
						...
						Versions: []v1alpha1.MachineImageVersion{
							{
								...
								CapabilityFlavors: []v1alpha1.MachineImageFlavor{
									...
									},
									{
										...
										Regions:      []v1alpha1.RegionIDMapping{{Name: "eu-west-1", ID: "id-124"}},
									},
								},
							},
						},
				...
				MachineImages: []v1alpha1.MachineImages{
					...
					},
					{
						...
						Versions: []v1alpha1.MachineImageVersion{
							{
								Version: "8.5",
								Regions: []v1alpha1.RegionIDMapping{{Name: "us-east-1", ID: "id-456"}},
							},
						},
					},
				},
