...
var _ = Describe("Helper", func() {
	...
	DescribeTable("#FindMachineImage",
		...
		Entry("entry not found (false encrypted)", []api.MachineImage{{Name: "bar", Version: "1.2.3", ID: "id123", Encrypted: Bool(false)}}, "bar", "1.2.3", true, nil, true),

		Entry("entry exists (encrypted value exists)", []api.MachineImage{{Name: "bar", Version: "1.2.3", ID: "id123", Encrypted: Bool(true)}}, "bar", "1.2.3", true, &api.MachineImage{Name: "bar", Version: "1.2.3", ID: "id123", Encrypted: Bool(true)}, false),
	...
	Describe("#AppendMachineImage",
		func() {
			...
			It("should append a non-existing image", func() {
				existingImages := []api.MachineImage{{Name: "bar", Version: "1.2.3", ID: "id123", Encrypted: Bool(true)}}
			...
			It("should not append the image", func() {
				imageToInsert := api.MachineImage{Name: "bar", Version: "1.2.3", ID: "id123", Encrypted: Bool(false)}
