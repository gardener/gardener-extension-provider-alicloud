...
bash "${PROJECT_ROOT}"/vendor/k8s.io/code-generator/generate-internal-groups.sh \
  deepcopy,defaulter \
  github.com/gardener/gardener-extension-provider-alicloud/pkg/client \
...
bash "${PROJECT_ROOT}"/vendor/k8s.io/code-generator/generate-internal-groups.sh \
  ...
  github.com/gardener/gardener-extension-provider-alicloud/pkg/apis \
  "alicloud:v1alpha1" \
  --extra-peer-dirs=github.com/gardener/gardener-extension-provider-alicloud/pkg/apis/alicloud,github.com/gardener/gardener-extension-provider-alicloud/pkg/apis/alicloud/v1alpha1,k8s.io/apimachinery/pkg/apis/meta/v1,k8s.io/apimachinery/pkg/conversion,k8s.io/apimachinery/pkg/runtime \
  --go-header-file "${PROJECT_ROOT}/vendor/github.com/gardener/gardener/hack/LICENSE_BOILERPLATE.txt"

bash "${PROJECT_ROOT}"/vendor/k8s.io/code-generator/generate-internal-groups.sh \
  deepcopy,defaulter \
  github.com/gardener/gardener-extension-provider-alicloud/pkg/client/componentconfig \
  github.com/gardener/gardener-extension-provider-alicloud/pkg/apis \
  github.com/gardener/gardener-extension-provider-alicloud/pkg/apis \
  "config:v1alpha1" \
  --go-header-file "${PROJECT_ROOT}/vendor/github.com/gardener/gardener/hack/LICENSE_BOILERPLATE.txt"
