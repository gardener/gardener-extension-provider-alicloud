...
import (
	...
	admissioncmd "github.com/gardener/gardener-extension-provider-alicloud/pkg/admission/cmd"
...
const AdmissionName = "admission-alicloud"

var log = logf.Log.WithName("gardener-extension-admission-alicloud")

// NewAdmissionCommand creates a new command for running an Alicloud admission webhook.
func NewAdmissionCommand(ctx context.Context) *cobra.Command {
	var (
		...
		mgrOpts  = &controllercmd.ManagerOptions{
			...
			WebhookCertDir:          "/tmp/admission-alicloud-cert",
		}
	...
	cmd := &cobra.Command{
		Use: fmt.Sprintf("admission-%s", provideralicloud.Type),
