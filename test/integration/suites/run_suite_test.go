...
import (
	...
	_ "github.com/gardener/gardener-extension-provider-alicloud/test/integration/healthcheck"
...
func TestGardenerSuite(t *testing.T) {
	RunSpecsWithDefaultAndCustomReporters(t, "Provider-alicloud Test Suite", []Reporter{reporter.NewGardenerESReporter(*reportFilePath, *esIndex)})
}
